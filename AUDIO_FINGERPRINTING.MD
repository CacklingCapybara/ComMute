...
**Note**: In-memory storage means fingerprints are lost on restart. For production use, consider implementing persistent storage or backing up fingerprints via the API.
